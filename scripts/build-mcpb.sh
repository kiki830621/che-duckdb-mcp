#!/bin/bash
# Build script for che-duckdb-mcp MCPB package
...
echo "=== che-duckdb-mcp MCPB Build Script ==="
...
ARM64_BINARY="$PROJECT_DIR/.build/arm64-apple-macosx/release/CheDuckDBMCP"
X64_BINARY="$PROJECT_DIR/.build/x86_64-apple-macosx/release/CheDuckDBMCP"
UNIVERSAL_BINARY="$SERVER_DIR/CheDuckDBMCP"
...
if command -v mcpb &> /dev/null; then
    ...
    echo ""
    echo "=== Build Complete ==="
    echo "MCPB package: $MCPB_DIR/che-duckdb-mcp.mcpb"
else
